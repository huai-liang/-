    ...
    <div class="menuContent">
      <div class="treeList">
        <div class="buttonArea">
          ...
          <el-button type="primary"
                     @click="editMenu">修改</el-button>
          <el-button type="primary"
                     @click="delMenu">删除</el-button>
          <el-button type="primary"
        ...
        <div class="detailBody">
          <el-form :model="menuDetail"
            ...
            <el-form-item label="菜单路径"
                          label-width="80px">
              <el-input v-model="menuDetail.url"
                        readonly></el-input>
            </el-form-item>
            <el-form-item label="分类"
                          label-width="80px">
              <el-select v-model="menuDetail.type"
                         disabled>
                <el-option label="目录"
                           value=2></el-option>
                <el-option label="菜单"
            ...
            <el-form-item label="排序"
                          label-width="80px">
              <el-input v-model="menuDetail.index"
                        readonly></el-input>
            </el-form-item>
    ...
    <el-dialog title="新增菜单"
      ...
      <el-form :model="addData"
        ...
        <el-form-item label="菜单名称"
                      label-width="80px"
                      prop="menuName">
          <el-input v-model="addData.menuName"
        ...
        <el-form-item label="菜单路径"
                      label-width="80px"
                      prop="menuUrl">
          <el-input v-model="addData.menuUrl"
                    autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="排序"
                      label-width="80px"
                      prop="index">
          <el-input v-model="addData.index"
                    type="number"
                    autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="备注"
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="sureAddData">确定</el-button>
      </div>
    </el-dialog>
    <el-dialog title="修改菜单"
      ...
      <el-form :model="editData"
        ...
        <el-form-item label="排序"
                      label-width="80px"
                      prop="index">
          <el-input v-model="editData.index"
                    type="number"
                    autocomplete="off"></el-input>
        </el-form-item>
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="sureEidtData">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
